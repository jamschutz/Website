var racerTypeDescriptions = {
    'religious': 'at the beginning of the race, before you start to cheer you can pray to the boshi gods for support. for each prayer, increase your speed by +2',
    ...
    'focuser': 'each time you cheer, multiply your speed by 1.05. when you cheer your racer on your phone, the cheer button will disappear each time you press and reappear at a random position on screen. when it reappears, the time it takes you to press the button will be added to the next disappearance interval.',
